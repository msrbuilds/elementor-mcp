...
class EMCP_Tools_Widget_Builder_Abilities {
	...
	private function register_list_control_types(): void {
		$this->ability_names[] = 'emcp-tools/list-control-types';
	...
	private function register_validate_widget_spec(): void {
		$this->ability_names[] = 'emcp-tools/validate-widget-spec';
		emcp_tools_register_ability(
			'emcp-tools/validate-widget-spec',
			array(
	...
	private function register_create_custom_widget(): void {
		$this->ability_names[] = 'emcp-tools/create-custom-widget';
		emcp_tools_register_ability(
			'emcp-tools/create-custom-widget',
			array(
	...
	private function register_update_custom_widget(): void {
		$this->ability_names[] = 'emcp-tools/update-custom-widget';
		emcp_tools_register_ability(
			'emcp-tools/update-custom-widget',
			array(
	...
	private function register_get_custom_widget(): void {
		$this->ability_names[] = 'emcp-tools/get-custom-widget';
		emcp_tools_register_ability(
			'emcp-tools/get-custom-widget',
			array(
	...
	private function register_list_custom_widgets(): void {
		$this->ability_names[] = 'emcp-tools/list-custom-widgets';
		emcp_tools_register_ability(
			'emcp-tools/list-custom-widgets',
			array(
	...
	private function register_set_widget_status(): void {
		$this->ability_names[] = 'emcp-tools/set-widget-status';
		emcp_tools_register_ability(
			'emcp-tools/set-widget-status',
			array(
	...
	private function register_delete_custom_widget(): void {
		$this->ability_names[] = 'emcp-tools/delete-custom-widget';
		emcp_tools_register_ability(
			'emcp-tools/delete-custom-widget',
			array(
